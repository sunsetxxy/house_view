...
def get_home_url(page):
    url = 'https://sh.esf.fang.com/house/i{}/'.format(page)
    headers = {
...
def save_data(data):
    ...
    print(data_frame)
    data_frame.to_csv('shanghai_fang.csv',header=False,index=False,mode='a',encoding='utf_8_sig')
...
def main(page):
    ...
    for url in urls:
        ...
        all_data = get_home_detail_infos(detail_url='https://sh.esf.fang.com'+url+'l')
        data = []
